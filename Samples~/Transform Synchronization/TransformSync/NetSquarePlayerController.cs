...
{
    /// <summary>
    /// Drives the local sample Player and publishes its synchronized transform state.
    /// </summary>
    public class NetSquarePlayerController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Draws the local ground-check diagnostic when sample debugging is enabled.
        /// </summary>
        ...
        /// <summary>
        /// Draws local Player state diagnostics when sample debugging is enabled.
        /// </summary>
        private void OnGUI()
        {
